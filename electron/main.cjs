    ...
    (() => {
      ...
      const ensureVersionHistoryDialog = () => {
        ...
        backdrop.innerHTML = [
          ...
          '<article class="unique-version-entry"><h3>Version 0.4.51</h3><ul><li>Favorisierte Nachrichten behalten einen dauerhaft sichtbaren gelben Stern in der Nachrichtenliste.</li><li>Gesendete Nachrichten koennen ueber Ribbon und Rechtsklick als vollstaendige, bearbeitbare Kopie erneut geoeffnet werden.</li><li>Erneut senden uebernimmt Absenderkonto, An, CC, BCC, Betreff, HTML-Inhalt und Anlagen; fehlende Inhalte werden zuvor aus dem lokalen Speicher oder vom IMAP-Server geladen.</li><li>Termin anlegen und Neuer Kontakt wurden im Start-Ribbon durch Erneut senden ersetzt.</li></ul></article>',
          '<article class="unique-version-entry"><h3>Version 0.4.50</h3><ul><li>Beim Einfuegen formatierter Zwischenablage-Inhalte kann zwischen Originalformatierung und reinem Text gewaehlt werden.</li><li>Schriftarten, Farben, Links, Listen und Absatzformatierungen aus Browsern und Office-Dokumenten werden zuverlaessiger uebernommen.</li><li>Die Einfuegeauswahl funktioniert im angedockten und abgekoppelten Verfassenfenster; unsichere aktive HTML-Inhalte werden entfernt.</li></ul></article>',
